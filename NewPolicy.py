...
from ppo_new.torch_layers import (
...
class ActorCriticPolicy(BasePolicy):
    ...
    def __init__(
        ...
        if net_arch is None:
            if features_extractor_class == NatureCNN:
                ...
                net_arch = dict(pi=[64, 64], vf=[64, 64])##here:default
        ...
        self.features_extractor = self.make_features_extractor() #output: function FlattenExtractor
        print('???debug01-self.features_extractor:',self.features_extractor)
        self.features_dim = self.features_extractor.features_dim
        print('???debug02-self.features_dim:',self.features_dim )
    ...
    def _build(self, lr_schedule: Schedule) -> None:
        ...
        """
        self._build_mlp_extractor()###change
    ...
    def forward(self, obs: th.Tensor, deterministic: bool = False) -> Tuple[th.Tensor, th.Tensor, th.Tensor]:
        ...
        print('???DEBUG08-latent_pi:',latent_pi,latent_pi.shape)
        actions = distribution.get_actions(deterministic=deterministic)
        # print('???DEBUG07-action raw:',actions)
...
class ActorCriticLstmPolicy(ActorCriticPolicy):
    """
